      ...
      <div className=" grid md:grid-cols-6 grid-cols-4 gap-6  mt-10">
        ...
        <div className="md:col-span-2 col-span-4 rounded-lg space-y-6 h-fit lg:sticky top-5">
          ...
          <div className="p-4 shadow-sm border space-y-4 border-neutral-200 rounded-md">
            ...
            <a
              className="text-black bg-primary w-full hover:shadow-lg justify-center   transition-all flex items-center gap-2 text-sm px-4 py-2 border font-medium border-neutral-300   rounded-full w-fit"
